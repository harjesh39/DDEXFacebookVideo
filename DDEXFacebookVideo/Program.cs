    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
...

            {
                ...
                string[] foldercreate = { "Facebook" };
                string foldername = string.Empty;
                var connectionString = string.Format("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + @"E:\DDEXFacebookVideo\DdexFacebook.xlsx" + ";Extended Properties=Excel 12.0;");
                ...
                foreach (var item in foldercreate)
                {
                    ...
                    for (int j = 0; j < CountRow; j++)
                    {
                        ...
                        //create directory
                        System.IO.Directory.CreateDirectory(@"E:\DDEXFacebookVideo\" + item + "\\" + foldername + "\\" + FileName);
                        System.IO.Directory.CreateDirectory(@"E:\DDEXFacebookVideo\" + item + "\\" + foldername + "\\" + FileName + "\\resources");
                        int tracksdds = j;
                        ...
                        XElement guvera = new XElement("MessageHeader"
                            ...
                            , new XElement("MessageThreadId", foldername), new XElement("MessageId", foldername)
                          //
                          //, new XElement("MessageId", DateTime.Now.ToString("yyyyMMddHHmmss") + "000")
                          ...
                          , new XElement("MessageRecipient", new XElement("PartyId", "PADPIDA2013071501L")
                          , new XElement("PartyId", "PADPIDA2018010804X")
                          , new XElement("PartyName", new XElement("FullName", "Facebook")))
                        ...
                        for (int l = 0; l < TrackCount; l++)
                        {
                            ...
                            if (ext.ToLower() == ".mp4" || ext.ToLower()==".mov")
                            {
                                ...
                                hashsumdestFile = System.IO.Path.Combine(@"E:\DDEXFacebookVideo\" + item + "\\" + foldername + "\\" + FileName + "\\resources", fi.Name);
                                updateHashSum = @"E:\DDEXFacebookVideo\" + item + "\\" + foldername + "\\" + FileName + "\\resources\\" + Upcdt.Rows[l]["FileName"].ToString() + ".mp4";
                            ...
                            UpdatedJpgHashSUm = @"E:\DDEXFacebookVideo\" + item + "\\" + foldername + "\\" + FileName + "\\resources\\" + Upcdt.Rows[l]["ImgID"].ToString() + ".jpg";
                            if (l == 0)
                            {
                                if (extimg.ToLower() == ".jpg")
                                {
                                    ...
                                    destFile = System.IO.Path.Combine(@"E:\DDEXFacebookVideo\" + item + "\\" + foldername + "\\" + FileName + "\\resources", fiimg.Name);
                           ...
                           , new XElement("Title", new XAttribute("TitleType", "FormalTitle"), new XElement("TitleText", Upcdt.Rows[l]["TTitleText"]), new XElement("SubTitle", "Live"))
                           ...
                           //, new XElement("OriginalResourceReleaseDate", Convert.ToDateTime(Upcdt.Rows[l]["OriginalReleaseDate"]).ToString("yyyy-MM-dd"))
                          ...
                          , new XElement("ExpressionType", "Informative"))
                           , new XElement("File", new XElement("FileName", Upcdt.Rows[l]["FileName"] + ".flac"), new XElement("FilePath", "resources/")
                        ...
                        // Start Image Tag============================================================
                        XElement ImageTag = new XElement("Image", new XElement("ImageType", "VideoScreenCapture"), new XElement("ImageId", new XElement("ProprietaryId", new XAttribute("Namespace", "DPID:DPID_OF_THE_RIGHTSHOLDER"), Upcdt.Rows[0]["GGL_USR_ID"]))
                        ...
                        , new XElement("File", new XElement("FileName", Upcdt.Rows[0]["ImgID"] + ".jpg"))
...

                        {
                            if (p == 0)
                            {
                             ...
                             , new XElement("ReleaseReference", "R" + p), new XElement("ReferenceTitle", new XElement("TitleText", Upcdt.Rows[p]["VideoTitleText"]), new XElement("SubTitle", "Live")));
                                ...
                                XElement ReleaseDetailsByTerritory = new XElement("ReleaseDetailsByTerritory", new XElement("TerritoryCode", Upcdt.Rows[p]["TerritoryCode"])
                                 ...
                                 , new XElement("Title", new XAttribute("TitleType", "FormalTitle"), new XElement("TitleText", Upcdt.Rows[p]["VideoTitleText"]), new XElement("SubTitle", "Live"))
                            ...
                            else if (p == TrackCount)
                            {
                                ...
                                //    , new XElement("CatalogNumber", new XAttribute("Namespace", "DPID:"), Upcdt.Rows[p - 1]["GGL_USR_ID"].ToString().Substring((Upcdt.Rows[p - 1]["GGL_USR_ID"].ToString().Length - 4), 4) + "_01" )
                                      ...
                                      , new XElement("ReleaseReference", "R" + p)
                                          ...
                                          , new XElement("ReferenceTitle", new XElement("TitleText", Upcdt.Rows[p - 1]["TTitleText"]), new XElement("SubTitle", "Live"))
                                          ...
                                          , new XElement("Title", new XAttribute("TitleType", "FormalTitle"), new XElement("TitleText", Upcdt.Rows[p - 1]["TTitleText"]), new XElement("SubTitle", "Live"))
                            ...
                            {
                                //XElement Release = new XElement("Release", new XElement("ReleaseId", new XElement("ISRC", Upcdt.Rows[p - 1]["ISRC"])
                                XElement Release = new XElement("Release", new XElement("ReleaseId", new XElement("ISRC", Upcdt.Rows[p - 1]["ISRC_video"])
                        ...
                        for (int q = 0; q <= TrackCount; q++)
                        {
                            ...
                            if (q == 0)
                            {
                                ReleaseDealTag = new XElement("ReleaseDeal", new XElement("DealReleaseReference", "R" + (q + 1))
                               , new XElement("Deal", new XElement("DealTerms", new XElement("CommercialModelType", "RightsClaimModel")
                               , new XElement("Usage"
                                , new XElement("UseType", "UserMakeAvailableUserProvided")
                               ...
                               //, new XElement("RightsClaimPolicy", new XElement("RightsClaimPolicyType", "Monetize"))
                                    ...
                                    , new XElement("Deal", new XElement("DealTerms"
                                    , new XElement("CommercialModelType", "RightsClaimModel")
                                    , new XElement("CommercialModelType", "AsPerContract")
                               , new XElement("Usage"
                                , new XElement("UseType", "UserMakeAvailableLabelProvided")
                               //  , new XElement("UseType", (item == "Saavn" ? "NonInteractiveStream" : "Stream"))
                               )
                               , new XElement("TerritoryCode", Upcdt.Rows[q]["TerritoryCode"])
                               , new XElement("ValidityPeriod", new XElement("StartDate", Convert.ToDateTime(Upcdt.Rows[q]["DealStartDate"]).ToString("yyyy-MM-dd")))
                            ...
                            else
                            {
                                ...
                                ////, new XElement("Deal", new XElement("DealTerms", new XElement("CommercialModelType", "AdvertisementSupportedModel")
                                ////, new XElement("Usage"
                                ////, new XElement("UseType", "Stream"))
                                ////, new XElement("TerritoryCode", Upcdt.Rows[q - 1]["TerritoryCode"])
                                ////, new XElement("ValidityPeriod", new XElement("StartDateTime", Upcdt.Rows[q - 1]["DealStartDate"]))))
                                //, new XElement("Deal", new XElement("DealReference", "D" + (q))
                                //, new XElement("DealTerms", new XElement("CommercialModelType", "AsPerContract")
                                //, new XElement("Usage"
                                // , new XElement("UseType", (item == "Saavn" ? "OnDemandStream" : "UserMakeAvailableLabelProvided"))
                                ////, new XElement("UseType", (item == "Saavn" ? "NonInteractiveStream" : "Stream"))
                                //)
                                //, new XElement("TerritoryCode", Upcdt.Rows[q - 1]["TerritoryCode"])
                                //, new XElement("ValidityPeriod", new XElement("StartDate", Convert.ToDateTime(Upcdt.Rows[q - 1]["DealStartDate"]).ToString("yyyy-MM-dd")))))
                                //);
                        ...
                        doc.Save(@"E:\DDEXFacebookVideo\" + item + "\\" + foldername + "\\" + FileName + "\\" + FileName + ".xml");
                        //  Console.ReadLine();
                        ...
                        if (item == "Spotify")
                        {
                            ...
                            XElement MessageInBatch = new XElement("MessageInBatch", new XElement("MessageType", "NewReleaseMessage")
                                ...
                                , new XElement("HashSum", new XElement("HashSum", GetHashSum(@"E:\DDEXFacebookVideo\" + item + "\\" + foldername + "\\" + FileName + "\\" + FileName + ".xml")), new XElement("HashSumAlgorithmType", "MD5"))
                                );
                            ...
                            docbatch.Save(@"E:\DDEXFacebookVideo\" + item + "\\" + foldername + "\\BatchComplete_" + foldername + ".xml");
                        }
                        else
                        {
                            doc.Save(@"E:\DDEXFacebookVideo\" + item + "\\" + foldername + "\\BatchComplete_" + foldername + ".xml");
                        }
                        System.Threading.Thread.Sleep(1000);
                    }
                    Console.WriteLine("DDEXFacebookVideo AND BATCH FILE --" + item + "-- CREATED SUCCESFULLY");
